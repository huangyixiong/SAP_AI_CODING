...
export const eyAntdTheme = {
  ...
  components: {
    ...
    Menu: {
      ...
      itemSelectedBg: 'rgba(255,230,0,0.18)',
      itemSelectedColor: EYColors.yellow,
      itemHoverBg: 'rgba(255,230,0,0.12)',
      groupTitleColor: 'rgba(255,255,255,0.68)',
      darkItemBg: 'rgba(255,255,255,0.03)',
      darkItemColor: 'rgba(255,255,255,0.92)',
      darkItemHoverBg: 'rgba(255,230,0,0.12)',
      darkItemHoverColor: '#FFF7A8',
      darkItemSelectedBg: 'rgba(255,230,0,0.22)',
      darkItemSelectedColor: EYColors.yellow,
      darkGroupTitleColor: 'rgba(255,255,255,0.68)',
